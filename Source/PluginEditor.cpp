...
void RollsWindow::resized()
{
    ...
    // move the row down by N pixels:
    const int topPad = 150; // <- change this to whatever vertical offset you want
    area.removeFromTop(topPad);

    auto row = area.removeFromTop(32);
    styleLbl.setBounds(row.removeFromLeft(120));
    styleBox.setBounds(row.removeFromLeft(160));
    howManyLbl.setBounds(row.removeFromLeft(100));
    howManyBox.setBounds(row.removeFromLeft(120));
