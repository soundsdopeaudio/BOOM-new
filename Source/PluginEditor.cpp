    ...
    drumGrid(p), pianoRoll(p)
{
    ...
    bounceSyncStrength.setTooltip("BounceSync strength: Light/Medium/Hard (amount of timing offset)");
    ...
    juce::MessageManager::callAsync([this, parameterID, newValue]()
        {
            ...
            {
                // combo is bound via attachment; no manual UI sync required generally
            }
