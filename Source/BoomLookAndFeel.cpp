    ...
    bool isButtonDown, int buttonX, int buttonY, int buttonW, int buttonH, juce::ComboBox& box)
{
    ...
    const juce::Colour arrowCol = juce::Colour::fromString("FF7cd400"); // lime green for arrow
    ...
    // DO NOT draw text here - JUCE's internal Label component handles text rendering
    // Drawing it here causes duplicate/overlapping text
