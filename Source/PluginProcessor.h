...
// ---- Bumppit (Drums path + Melodic path) ----                                               // DRUMS ONLY
    ...
    bool isRhythmimickRecording() const noexcept { return recRh_; }
    bool isBeatboxRecording()     const noexcept { return recBx_; }
    ...
    // Call these from your Record buttons:
    void startRhythmimickRecording() noexcept { recRh_ = true;  rmsRhL_ = rmsRhR_ = 0.0f; }
    void stopRhythmimickRecording()  noexcept { recRh_ = false; }
    void startBeatboxRecording()     noexcept { recBx_ = true;  rmsBxL_ = rmsBxR_ = 0.0f; }
    void stopBeatboxRecording()      noexcept { recBx_ = false; }
